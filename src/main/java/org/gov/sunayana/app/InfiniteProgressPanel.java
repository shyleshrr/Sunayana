...
public class InfiniteProgressPanel extends JComponent implements MouseListener
{
    ...
    protected float   shield     = 0.00f;
    /** Message displayed below the circular shape. */
    protected String  text       = "Processing....please wait";
    ...
    {
        this(text, barsCount, shield, 5.0f);
    }
    ...
    public void paintComponent(Graphics g)
    {
        if (started)
        {
            ...
            if (text != null && text.length() > 0)
            {
	            ...
	            this.setForeground(new java.awt.Color(9,84,34));
    ...
    private Area[] buildTicker()
    {
        ...
        for (double i = 0.0; i < (double) barsCount; i++)
        {
            ...
            AffineTransform toBorder = AffineTransform.getTranslateInstance(10.0, -6.0);
